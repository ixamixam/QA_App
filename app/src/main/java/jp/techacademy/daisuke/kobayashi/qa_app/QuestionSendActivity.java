...
public class QuestionSendActivity extends AppCompatActivity implements View.OnClickListener, DatabaseReference.CompletionListener {
    ...
    // ギャラリーから選択するIntentとカメラで撮影するIntentを作成して、
    // さらにそれらを選択するIntentを作成してダイアログを表示させる
    private void showChooser() {
        // ギャラリーから選択するIntent,こういう書き方
        ...
        // そしてそのIntentに対し、2つ目のIntentを指定することでこれら2つのIntentを選択するダイアログを表示される
